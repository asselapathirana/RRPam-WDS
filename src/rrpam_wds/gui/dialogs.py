...
from PyQt4.QtGui import QDialog, QApplication, QMdiSubWindow, QAbstractSpinBox, QMainWindow, QMdiArea, QAction, QTextEdit
...
class MainWindow(QMainWindow):
    ...
    def new_window(self, closable=True):
        win = MyCurveDialog(edit=False, toolbar=True, wintitle="CurveDialog test",
