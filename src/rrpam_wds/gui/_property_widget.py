...
class Ui_projectDataWidget(object):
    ...
    def setupUi(self, projectDataWidget):
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 348, 292))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 332, 105))
        ...
        self.assign_asset_item = QtWidgets.QFrame(self.scrollAreaWidgetContents)
        self.assign_asset_item.setObjectName("assign_asset_item")
        self.indiviual_asset_container_layout_4 = QtWidgets.QHBoxLayout(self.assign_asset_item)
        self.indiviual_asset_container_layout_4.setObjectName("indiviual_asset_container_layout_4")
        self.label_8 = QtWidgets.QLabel(self.assign_asset_item)
        self.label_8.setMaximumSize(QtCore.QSize(50, 16777215))
        self.label_8.setObjectName("label_8")
        self.indiviual_asset_container_layout_4.addWidget(self.label_8)
        self.my_id = QtWidgets.QLabel(self.assign_asset_item)
        ...
        self.indiviual_asset_container_layout_4.addWidget(self.my_id)
        self.label_9 = QtWidgets.QLabel(self.assign_asset_item)
        self.label_9.setObjectName("label_9")
        self.indiviual_asset_container_layout_4.addWidget(self.label_9)
        self.my_group = QtWidgets.QComboBox(self.assign_asset_item)
        self.my_group.setMaximumSize(QtCore.QSize(100, 16777215))
        self.my_group.setObjectName("my_group")
        self.indiviual_asset_container_layout_4.addWidget(self.my_group)
        spacerItem3 = QtWidgets.QSpacerItem(
            40,
            20,
            QtWidgets.QSizePolicy.Expanding,
            QtWidgets.QSizePolicy.Minimum)
        self.indiviual_asset_container_layout_4.addItem(spacerItem3)
        self.assign_asset_item_parent_layout.addWidget(self.assign_asset_item)
        spacerItem4 = QtWidgets.QSpacerItem(
            20,
            40,
            QtWidgets.QSizePolicy.Minimum,
            QtWidgets.QSizePolicy.Expanding)
        self.assign_asset_item_parent_layout.addItem(spacerItem4)
    ...
    def retranslateUi(self, projectDataWidget):
        ...
        self.label_8.setText(_translate("projectDataWidget", "ID: "))
        self.my_id.setText(_translate("projectDataWidget", "idvalue"))
        self.label_9.setText(_translate("projectDataWidget", "Group"))
        self.asset_groups_and_assignments.setTabText(
