...
class test_main_window(Test_Parent):
    ...
    def test_attempting_to_close_will_minimize_network_map_and_risk_matrix_and_the_last_wlc_window(
            self):
    ...
    def test_multiple_wlc_windows_can_be_added(self):
        list1 = self.aw.mdi.subWindowList()
    ...
    def test_last_remaining_wlc_window_will_not_be_deleted_but_minimized(self):
        list1 = self.aw.mdi.subWindowList()
